<?php
/* Smarty version 3.1.31, created on 2017-12-06 08:45:21
  from "D:\install\wamp64\www\wwtestProduct\active\templates\list.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.31',
  'unifunc' => 'content_5a27ae21dba157_15243206',
...
function content_5a27ae21dba157_15243206 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
...
<div class="row">
    <div class="col-lg-12 col-sm-12 col-xs-12">
	    ...
	    <!--Basic Scripts-->
    <?php echo '<script'; ?>
 src="./templates/style/jquery_002.js"><?php echo '</script'; ?>
>
    <?php echo '<script'; ?>
 src="./templates/style/bootstrap.js"><?php echo '</script'; ?>
>
    <?php echo '<script'; ?>
 src="./templates/style/jquery.js"><?php echo '</script'; ?>
>
    <!--Beyond Scripts-->
    <?php echo '<script'; ?>
 src="./templates/style/beyond.js"><?php echo '</script'; ?>
>
